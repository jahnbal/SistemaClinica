...
static void executarOpcao(char opcao, Carrinho *carrinho, FILE *arq_produtos,
                          FILE *arq_vendas, int *venda_concluida);
...
static void opcao_finalizar(Carrinho *carrinho, FILE *arq_produtos,
                            FILE *arq_vendas, int *venda_concluida) {
